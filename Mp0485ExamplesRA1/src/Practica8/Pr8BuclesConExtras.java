 ...
 * @author Lucifer
 */
public class Pr8BuclesConExtras {
...
//pero aún se puede controlar la condición de terminación del bucle.
  ...
  /*      
        ...
        String espacio2 = " ";
        for (int i = 0; i < frase.length(); i++) {
            System.out.println(espacio+frase.charAt(i));
...
*/
    ...
    static void ejercicio4(){
        ...
        /*
        System.out.println();
        for (int row = 2; row <= larg; row++) {
            System.out.printf("%4d", row);
            for (int col = 2; col <= larg; col++) {
                        ...
                        hitV = ran;
                            if (hitV < 5) {
                                ...
                                if (hitV < 10) {
                                    ...
                                    if (dice >= 5){
                                        System.out.println("Golpe critico del Enemigo!!!");
                                    } else if (dice < 5) {
                                        hitV = 0;
